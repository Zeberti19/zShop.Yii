...
class Encode
{
    ...
    /**
     * Формирует хеш для какого-либо пароля. При хешировании используются 2 соли: указанная (индивидуальная) соль плюс глобальная соль.
     *
     * @param string $password
     *          Пароль, хэш которого нужно получить
     * @param $saltIndiv
     *          Индвидуальная соль для хеширования пароля.
     * @return string
     */
    static public function passwordEncode($password,$saltIndiv)
    {
        return sha1($password.$saltIndiv.PASSWORD_SALT_GLOBAL);
    }
}