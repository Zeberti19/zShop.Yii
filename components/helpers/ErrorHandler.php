...
{
    /**
     * Путь до файла, в который будут записываться собственные логи ошибок. Путь устанавливается в классе InitMain.php,
     ...
     *          Путь до файла, где возникла ошибка, а также до строчки, где она возникла
     * @param string $code
