...
{
    window.location.assign('?r=admin/users/admin/data-view-next&dataViewId=' + encodeURIComponent(Admin.dataViewId))
};
...
Admin.userDelete=function()
{
    ...
    if ('self'==Admin.dataViewId)
    {
        window.location.assign('/?r=admin/users/admin/user-delete&id=' + encodeURIComponent(rowSelected.attributes['data-user_id'].value));
    }
    else if ('yii2'==Admin.dataViewId)
    {
